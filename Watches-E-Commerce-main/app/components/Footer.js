      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-12">
        <div className="grid grid-cols-1 md:grid-cols-4 gap-8">
          ...
          <div className="space-y-4">
            <h3 className="text-lg font-bold">Mordern Watch</h3>
            <p className="text-gray-300">
              Luxury timepieces for the discerning collector. Quality, elegance, and precision in every watch.
            </p>
          </div>
          ...
          <div className="space-y-4">
            ...
            <ul className="space-y-2">
              ...
              <li><a href="/warranty" className="text-gray-300 hover:text-white">Warranty</a></li>
          ...
          <div className="space-y-4">
            ...
            <ul className="space-y-2">
              <li className="text-gray-300">123 Watch Street</li>
              <li className="text-gray-300">City, State 12345</li>
              <li className="text-gray-300">Phone: (123) 456-7890</li>
              <li className="text-gray-300">Email: info@timepiece.com</li>
            </ul>
          </div>
        </div>
        ...
        <div className="mt-8 pt-8 border-t border-gray-800">
          <div className="flex justify-between items-center">
            <p className="text-gray-300">
              © {new Date().getFullYear()} MordernWatch. All rights reserved.
            </p>
